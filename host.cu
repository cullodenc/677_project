...
/*----------------------------------------------------------------------------MERKLE TREE KERNEL---------------------------------------------------------------------------*/
//__host__ void launchMerkle(cudaStream_t * stream, BYTE ** block_d, BYTE ** hash_d, BYTE ** nonce_d, BYTE ** block_h, BYTE ** hash_h, BYTE ** nonce_h, BYTE ** target_d, int ** flag_d,  int * flag_h, int * target_length);
...
/*-------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
__host__ void benchmarkKernel(int num_workers);
